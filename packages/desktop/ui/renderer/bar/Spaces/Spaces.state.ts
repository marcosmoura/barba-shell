...
export const useSpaces = () => {
  ...
  const onCliCommandReceived = useCallback(
    ({ payload: { name } }: { payload: CLICommandPayload }) => {
  ...
  useTauriEvent<CLICommandPayload>(CliEvents.COMMAND_RECEIVED, onCliCommandReceived);
